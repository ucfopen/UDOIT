...
*/
?>
<h2 class="content-title"><?= ucfirst($content_group->title); ?> <small> <b><?= count($content_group->items); ?><b> of <?= $out_of_items; ?> have issues.</small> <span class="proc-time">process time: <?= $time; ?>s</span></h2>
