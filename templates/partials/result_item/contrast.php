	...
	<div class="left">
		<div class="form-group no-margin margin-bottom">
			<?php if ( isset($group_item->back_color) ): ?>
				...
				<input class="color {hash:true,caps:false} form-control back-color" type="text" name="newcontent[0]" value="<?= $group_item->back_color; ?>" placeholder="Replacement for Background Color <?= $group_item->back_color; ?>" id="<?= $this->e($item_id);?>-bgcolor">
				<a href="#" class="color-change" id="bglighten" onclick="changehue('<?= $this->e($item_id);?>-bgcolor', 'lighten'); return false;">lighten</a> | <a href="#" class="color-change" id="bgdarken" onclick="changehue('<?= $this->e($item_id);?>-bgcolor', 'darken'); return false;">darken</a>
				<br><br>
			<?php endif; ?>
			...
			<input class="color {hash:true,caps:false} form-control fore-color" type="text" name="newcontent[1]" value="<?= $group_item->fore_color; ?>" placeholder="Replacement for Foreground Color <?= $group_item->fore_color; ?>" id="<?= $this->e($item_id); ?>-fgcolor">
			<a href="#" class="color-change" id="fglighten" onclick="changehue('<?= $this->e($item_id); ?>-fgcolor', 'lighten'); return false;">lighten</a> | <a href="#" class="color-change" id="fgdarken" onclick="changehue('<?= $this->e($item_id); ?>-fgcolor', 'darken'); return false;">darken</a>
			<br><br>
