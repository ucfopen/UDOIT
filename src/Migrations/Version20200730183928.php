 ...
 */
final class Version20200730183928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution ADD api_client_id INT DEFAULT NULL, ADD api_client_secret VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution DROP api_client_id, DROP api_client_secret');
    }
}
