 ...
 */
final class Version20200611161702 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, course_id INT NOT NULL, data LONGTEXT DEFAULT NULL, created DATETIME NOT NULL, errors INT DEFAULT NULL, suggestions INT DEFAULT NULL, INDEX IDX_C42F7784591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
