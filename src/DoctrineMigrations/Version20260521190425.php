 ...
 */
final class Version20260521190425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE institution CHANGE api_client_secret api_client_secret_encrypted VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE institution CHANGE api_client_secret_encrypted api_client_secret VARCHAR(255) DEFAULT NULL');
