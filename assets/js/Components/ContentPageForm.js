...
export default function ContentPageForm({ t, searchTerm, handleSearchTerm, handleTableSettings, handleTrayToggle, tableSettings }) {
    ...
    <Flex alignItems="center" justifyItems="space-between" key="contentPageForm">
      ...
      <Flex.Item>
          ...
          <Button
            ...
            screenReaderLabel={t('srlabel.open_filters_tray')}
