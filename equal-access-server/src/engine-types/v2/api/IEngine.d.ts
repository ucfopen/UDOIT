 ...
 *****************************************************************************/
import { Issue, RulePass as RulePassNew, RuleFail as RuleFailNew, RuleRender as RuleRenderNew, RulePotential as RulePotentialNew, RuleManual as RuleManualNew, RuleResult as RuleResultNew, RuleContextHierarchy as RuleContextHierarchyNew, RuleContext as RuleContextNew, Rule as RuleNew } from "../../v4/api/IRule";
import { NlsMap as NlsMapNew, HelpMap as HelpMapNew, IEngine as IEngineNew } from "../../v4/api/IEngine";
import { Report as ReportNew } from "../../v4/api/IReport";
/**
 ...
 * @deprecated See ../../v4/api/IRule
 */
export declare const RulePass: typeof RulePassNew;
/**
 * @deprecated See ../../v4/api/IRule
 */
export declare const RuleRender: typeof RuleRenderNew;
/**
 * @deprecated See ../../v4/api/IRule
 */
export declare const RuleFail: typeof RuleFailNew;
/**
 * @deprecated See ../../v4/api/IRule
 */
export declare const RulePotential: typeof RulePotentialNew;
/**
 * @deprecated See ../../v4/api/IRule
 */
export declare const RuleManual: typeof RuleManualNew;
/**
 * @deprecated See ../../v4/api/IRule
 */
